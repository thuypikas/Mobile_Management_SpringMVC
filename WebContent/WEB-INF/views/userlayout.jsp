	...
	<div id="header">
		<div class="container">
			<div id="welcomeLine" class="row">
				<c:if test="${user!=null }">
					<div class="span6">
						Chào mừng !<strong><a href="usermodify">${user.getFirstName() }</a> </strong>
					</div>
					<div class="span6">
						<div class="pull-right">
							<a href="login?logout="><span class="btn btn-small btn-success">Đăng
									xuất</span></a>
						</div>
					</div>
				</c:if>
				...
				<div class="span6">
				<div class="pull-right">
							<a href="register.html"><span class="btn btn-small btn-success">Đăng
									ký </span></a>
						</div>
						<div class="pull-right">
			...
			<div id="logoArea" class="navbar">
				...
				<div class="navbar-inner">
					<a class="brand" href="index.html"><img
						src="themes/images/logo.png"  /></a>
					<form class="form-inline navbar-search" method="get"
						action="search">
						<input id="srchFld" class="srchTxt" name="pname" type="text" /> <select name="catid"
							class="srchTxt">
					...
					<ul id="topMenu" class="nav pull-right">
						...
						<li class=""><a href="products.html">Khuyến mại</a></li>
