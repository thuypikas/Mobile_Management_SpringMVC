	...
	<div class="row">	  
			...
			<div class="span6">
				...
				<form class="form-horizontal qtyFrm" action="cart" method="post">
				  <div class="control-group">
					<label class="control-label"><span>$${product.unitprice }</span></label>
					<div class="controls">
					<input type="number" class="span1" placeholder="Qty."/>
								<button type="submit" class="btn btn-large btn-primary pull-right"> Add to cart <i class=" icon-shopping-cart"></i></button>
									...
									<input type="hidden" name="productname"
										...
										name="unitprice" value="${product.unitprice }"> <input
										type="hidden" name="picture" value="${product.picture }"> <input
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Product Information</h4>
				...
				<tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2">${product.supplier.companyname }</td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Model:</td><td class="techSpecTD2">FinePix S2950HD</td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Operating System</td><td class="techSpecTD2">${product.operatingsystem }</td></tr>
				...
				<tr class="techSpecRow"><td class="techSpecTD1">Display size:</td><td class="techSpecTD2">${product.screensize }</td></tr>
				</tbody>
				</table>
