		...
		<div class="left-content">
			<div class="mother-grid-inner">
							...
							<ul>
								<li class="dropdown profile_details_drop"><a href="#"
									...
									<ul class="dropdown-menu drp-mnu">
										...
										<li><a href="admin?logout"><i class="fa fa-sign-out"></i> Logout</a>
										</li>
									</ul></li>
							</ul>
						</div>
				...
				<div class="copyrights">
					<p>
						© 2018 Pikas. All Rights Reserved | Design by <a
							href="http://w3layouts.com/" target="_blank">Nhom 1</a>
					</p>
				</div>
				...
				<ul id="menu">
					...
					<li><a href="#"><i class="fa fa-shopping-cart"></i><span>E-Commerce</span><span
						...
						<ul id="menu-academico-sub">
							<li id="menu-academico-avaliacoes"><a href="admin/productmgt.html">Product</a></li>
							<li id="menu-academico-avaliacoes"><a href="admin/orders.html">Orders</a></li>
						</ul></li>
